...
# Пауза между карточками в фоновом job: держим ~60-70 req/мин к media/save,
# оставляя запас в общем пуле Контента (100/мин) для параллельных действий.
JOB_ITEM_PAUSE_SECONDS = 0.4
