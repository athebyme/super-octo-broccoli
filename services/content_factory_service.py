...
5. ОБЯЗАТЕЛЬНО вставь ссылку на товар: {wb_url} — без ссылки пост бесполезен!
...
_BUILTIN_USER_PROMPTS = {
    'promo_post': (
        ...
        '4. ОБЯЗАТЕЛЬНО вставь ссылку: {wb_url}\n'
        '5. Призыв к действию\n'
        '6. 3-5 хештегов в конце отдельным блоком\n'
        '7. НЕ пиши "ИП", "ООО" и другие юридические формы'
    ),
    'review': (
        'Напиши обзор товара:\n\n'
        'Название: {product_name}\n'
    ...
    'carousel': (
        ...
        '2. Каждый товар: название, описание (1-2 предложения), цена, ССЫЛКА на WB\n'
        '3. Призыв к действию\n4. Хештеги\n'
    ...
    def _ai_review_step(
        ...
        try:
            review_prompt = (
                ...
                f'2. Есть ли ссылка на товар ({wb_url})? Если нет — ОБЯЗАТЕЛЬНО добавь\n'
