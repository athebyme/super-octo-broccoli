...
class SmartCategoryMapper:
    ...
    # Бренд-хинты удалены: бренды производят товары в разных категориях,
    # жёсткая привязка бренда к одной категории приводит к ошибкам.
    # Например Doc Johnson делает и фаллоимитаторы, и мастурбаторы.
    # AI и CSV-категория поставщика — более надёжные источники.
