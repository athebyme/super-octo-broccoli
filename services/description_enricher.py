...
class DescriptionEnricher:
    ...
    MATERIAL_PATTERNS = [
        # Для label-формы разделитель обязателен. Без него фраза вроде
        # «сохранить материал в наилучшем виде» ошибочно становилась материалом.
        r'\bматериал(?:\s+(?:изделия|товара))?\s*[:\-–]\s*'
        r'([а-яёa-z\s,/]+?)(?:\.|,\s*[а-яёА-ЯЁ]|\n|$)',
