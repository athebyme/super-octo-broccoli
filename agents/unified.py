...
class UnifiedSellerAgent(BaseAgent):
    ...
    def _plan_request(self, task: dict, input_data: dict) -> dict:
        ...
        try:
            ...
            if selected_ids:
                scope_name = (
                    f'карточку #{selected_ids[0]}' if len(selected_ids) == 1
        ...
        had_trusted_selection = bool(selected_ids)
        scope_mode = 'active' if selected_ids else 'global'
        if selected_ids and planned.get('scope_mode') == 'global':
            scope_mode = 'global'
            product_ids = []
            listing_ids = []
            selected_ids = []
    ...
    def _compact_result(result: dict) -> dict:
        ...
        compact = {
            ...
            for key in (
                ...
                'entity_kind', 'collection_title',
                'marketplace_code', 'account_id',
                'details',
                'requested_fields',
