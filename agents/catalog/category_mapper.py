        ...
        if task_type == 'map_single':
            ...
            if imported_product_id:
                return (
                    ...
                    f"4. Сохрани категорию: update_product(product_id={imported_product_id}, data={{\"wb_category_id\": subject_id}})\n\n"
            ...
            return (
                ...
                f"4. Сохрани категорию: update_product(product_id={product_id}, data={{\"wb_category_id\": subject_id}})\n\n"
                f"ВАЖНО: ОБЯЗАТЕЛЬНО вызови update_product для сохранения категории.\n\n"
                f"Верни JSON: {{subject_id, subject_name, parent_category, confidence, reasoning}}"
            )
            ...
            if products_data:
                ...
                return (
                    ...
                    f"2. Сохрани категорию: update_product(product_id=ID, data={{\"wb_category_id\": subject_id}})\n\n"
            ...
            return (
                ...
                f"3. Для каждого товара сохрани: update_product(product_id=ID, data={{\"wb_category_id\": subject_id}})\n\n"
                f"ВАЖНО:\n"
